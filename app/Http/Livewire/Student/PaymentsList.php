...
class PaymentsList extends Component
{
    ...
    public function mount()
    {
        ...
        if (auth()->user()) {
            if (session()->has('download_next_tuition') && session()->get('download_next_tuition')) {
                $params = session()->get('download_params_tuition');
                redirect()->route('students-tuition-by-faculty', [
    ...
    {
        $this->validate();
        return redirect()->route('download_student_payments_list', [
            'fac_id' => $this->fac_id,
    ...
    public function downloadByFaculty()
    {
        ...
        return redirect()->route('students-tuition-by-faculty', [
    ...
    public function render()
    {
        ...
        return view('livewire.student.payments-list', compact('faculties', 'departments', 'programmes', 'programme_types', 'levels', 'options', 'semesters', 'sessions'));
    }
}
