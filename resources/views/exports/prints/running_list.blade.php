<x-print-layout :title="'Running List'">
    <style>
        * {
        ...
        <div class="text-justify">
            ...
            <div class="row">
                ...
                <div class="col-6 text-center">
                    <div class="h6" style="text-decoration: underline;">running list</div>
                </div>
                <div class="col-3">
                    @if ($hasPresentation)
                        <div class="h6">bos no:
    ...
    <div class="footer">
        ...
        <div class="item">
            @if (Route::is('hod.results.running-list'))
                COORDINATOR'S COPY
            @elseif(Route::is('hod.results.running-list-vetter'))
                VETTER'S COPY
            @elseif(Route::is('hod.results.running-list-bos'))
                B.O.S' COPY
            @endif
