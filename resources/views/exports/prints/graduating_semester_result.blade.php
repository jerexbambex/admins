<x-print-layout :title="'Graduating Semester Result'" :landscape="'true'">
    <style>
        * {
        ...
        <div class="text-justify">
            <div class="row">
                ...
                <div class="col-9 text-center">
                    <div class="h6">
                        <span style="text-decoration:underline;">graduating semester result </span>
                        &nbsp; - &nbsp;
                ...
                <tbody>
                    ...
                    @foreach ($students_list as $student)
                        ...
                        <tr>
                            ...
                            {{-- Previous --}}
                            @foreach ($student['previous'] as $prev)
                                <td class="<?= $key < count($student['previous']) - 1 ? 'ignore' : 'remove-left' ?>">
                                    {{ $prev }}</td>
                            @endforeach

                            {{-- Present --}}
                            @foreach ($student['present'] as $pres)
                                <td class="<?= $key < count($student['present']) - 1 ? 'ignore' : 'remove-left' ?>">
                                    {{ $pres }}</td>
                            @endforeach


                            {{-- Cumulative --}}
                            @foreach ($student['cumulative'] as $cumulative)
                                <td class="<?= $key < count($student['cumulative']) - 1 ? 'ignore' : 'remove-left' ?>">
                                    {{ $cumulative }}</td>
                            @endforeach
    ...
    <div class="header">
        ...
        <div class="text-justify">
            <div class="row">
                ...
                <div class="col-9 text-center">
                    <div class="h6">
                        <span style="text-decoration:underline;">graduating result statistics </span>
                        &nbsp; - &nbsp;
                        <span style="text-decoration:underline;">{{ SEMESTERS[$semester_id] }}</span>
                    </div>
                </div>
