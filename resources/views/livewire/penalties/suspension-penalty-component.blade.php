                    ...
                    <div class="card-body">
                        ...
                        <form wire:submit.prevent="submit">
                            ...
                            @else
                                ...
                                <div class="form-group">
                                    <label>Penalty</label>
                                    <input type="text" readonly value="Suspension" class="form-control" />
                                </div>
                                <div class="form-group">
                                    <label>Session</label>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-body">
                                <div class="form-group">
                                    <label>Session</label>
                                    <select wire:model="filter_course_session" class="form-control">
                                        <option value="">Select . . .</option>
                                        @foreach ($sessions as $sess)
                                            <option>{{ $sess->session }}</option>
                                        @endforeach
                                ...
                                <div class="form-group">
                                    ...
                                    @endphp
                                    <label>Level</label>
                                    <select wire:model="filter_course_level_id" class="form-control">
                                        <option value="">Select . . .</option>
                                        @foreach ($levels as $key => $lvl)
                                            <option value="{{ $key }}">{{ $lvl }}</option>
                                        @endforeach
                                ...
                                <div class="form-group">
                                    <label>Semester</label>
                                    <select wire:model="filter_course_semester" class="form-control">
                                        <option value="">Select . . .</option>
                                        @foreach (range(1, $semesters) as $sem_id)
                                            <option value="{{ $sem_id }}">{{ SEMESTERS[$sem_id] }}</option>
                                        @endforeach
                                ...
                                <div class="form-group">
                                    <button type="button" wire:click="getPrevSemesterCourses"
                                        wire:loading.attr="disabled" class="btn btn-block btn-secondary">Load
                                        Courses</button>
                                </div>
                            </div>
                            <ul style="list-style: none">
                                @foreach ($prev_sem_courses as $c)
                                    <li>
                                        <div class="form-group">
                                            <input id="select_course_{{ $c->thecourse_id }}" type="checkbox"
                                                wire:click="setToDelete({{ $c->thecourse_id }})" />
                                            <label
                                                for="select_course_{{ $c->thecourse_id }}">{{ sprintf('%s (%s)', $c->thecourse_title, $c->thecourse_code) }}</label>
                                        </div>
                                    </li>
                                @endforeach
                            </ul>
