    ...
    @if ($layout == 'form')
        <div class="row">
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body">
                        <div class="card-title">Student's Expulsion Form</div>
                        ...
                        <form wire:submit.prevent="submit">
                            ...
                            @else
                                ...
                                <div class="form-group">
                                    <label>Penalty</label>
                                    <input type="text" readonly value="Expulsion" class="form-control" />
                                </div>
                                <div class="form-group">
                                    <label>Date Expelled</label>
