    ...
    @if ($layout == 'form')
        <div class="row">
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body">
                        <div class="card-title">Student's Indefinite Suspension Form</div>
                        ...
                        <form wire:submit.prevent="submit">
                            ...
                            @else
                                ...
                                <div class="form-group">
                                    <label>Penalty</label>
                                    <input type="text" readonly value="Indefinite Suspension" class="form-control" />
                                </div>
                                <div class="form-group">
                        ...
                        <tbody>
                            ...
                            @forelse ($penalties as $penalty)
                                <tr>
                                    ...
                                    <td>
                                        @if ($penalty->reinstated_at === null)
                                            <button type="button" class="btn btn-sm btn-block btn-outline-secondary"
                                                wire:click="reinstate({{ $penalty->id }})" wire:loading.attr="disbaled"
                                                onclick="confirm('Are you sure you want to reinstate this student?') || event.stopImmediatePropagation()">
                                                Reinstate
                                            </button>
                                        @endif
                                    </td>
