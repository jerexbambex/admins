<div>
    <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="card-title">
                        <label>{{ ucfirst($action) }} H.O.D</label>
                        @if ($action == 'update')
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-body">
                    <div class="card-title">H.O.D's Filter</div>

                    <div class="form-body">
                        <div class="form-group col-md">
                            <label>Faculty</label>
                            <select class="form-control" wire:model="filter_faculty">
                                <option value="">All</option>
                                @foreach ($faculties as $f)
                                    <option value="{{ $f->faculties_id }}">{{ $f->faculties_name }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group col-md">
                            <label>Department</label>
                            <select class="form-control" wire:model="filter_department">
                                <option value="">All</option>
                                @foreach ($filterdepartments as $d)
                                    <option value="{{ $d->departments_id }}">{{ $d->departments_name }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group col-md">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="card-title">H.O.D's List</div>
